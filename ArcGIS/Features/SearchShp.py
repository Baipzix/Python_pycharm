...
def main():
    ...
    flist = []
    docname=r"C:\Users\haitaol\Documents\Projects\SOP\ShapeFileList.txt"
    ...
    dirlist=[r"V:\Shared\Regulatory\TOLKO_DLO_APP\Data\Allan Lidar Data"]
    docname=r"C:\Tolko\2018\ShapeFileList.txt"
